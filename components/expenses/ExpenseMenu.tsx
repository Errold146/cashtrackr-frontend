...
export function ExpenseMenu({expenseId}: {expenseId: Expense['id']}) {
                ...
                >
                    <MenuItems className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white p-2 shadow-lg ring-1 ring-gray-900/5 focus:outline-none">
                        <MenuItem>
                            <button
                                type='button'
                                className='block p-2 rounded-lg text-sm leading-6 text-gray-900 hover:bg-slate-100 hover:underline hover:text-purple-950 transition-colors duration-300 text-left w-full'
