        ...
        <div className='mb-5'>
            <div className="sm:hidden">
                ...
                <select
                    id="tabs"
                    name="tabs"
                    className="block w-full rounded-lg border-2 border-gray-300 bg-white px-4 py-3 text-base font-medium text-gray-900 shadow-sm focus:border-purple-800 focus:ring-2 focus:ring-purple-800 focus:outline-none transition-colors"
